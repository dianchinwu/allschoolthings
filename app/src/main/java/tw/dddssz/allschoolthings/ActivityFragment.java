...
//    private MyAdapter_A0003_Activity adapter;
...
//        }
        ...
        // 將資料交給adapter
//        adapter = new MyAdapter_A0003_Activity(getActivity(),mData);
...
//                        personUtils.setJobProfile(jsonObject.getString("jobprofile"));
                ...
                mAdapter = new MyAdapter_A0003_Activity(getActivity(),parentchildActivityList);
