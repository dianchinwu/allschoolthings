...
public class MyAdapter_A0003_Activity extends RecyclerView.Adapter<MyAdapter_A0003_Activity.ViewHolder> {
...
//    private List<String> mData;
    ...
    public MyAdapter_A0003_Activity(Context context, List parentchildActivity) {
        this.context = context;
        this.parentchildActivity = parentchildActivity;
    }

//    MyAdapter_A0003_Activity(List<String> data) {
//        mData = data;
//    }
